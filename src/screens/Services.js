        ...
        <div className="app justify">
          ...
          <div>
            <p>
              ...
              elementary health education. Health and community care has become
              a cornerstone of humanitarian assistance and accounts for a large
              part of Red Cross spending. Through these programmes, the Red
              Cross aims to enable communities to reduce their vulnerability to
              disease and be prepared for facing and responding to various
              public health crises.
            </p>
            <p>
              Guiding and supporting the development of its Societies is one of
              the fundamental tasks of IRCS/YRC and runs through the above four
              core areas. Likewise Capacity building programmes and activities
              include : management and volunteer training, improving branch
              structures, planning, fund-raising and gender equality. Which will
              create the opportunity for Red Cross Societies to network .
            </p>
            <h5>Other Major activities include:</h5>
            <p>
              Hospital services <br /> HIV/AIDS awareness <br /> Building home
              for the needy <br /> Vocational training <br /> Tracing activities{" "}
              <br /> Maternity , child and family welfar <br /> Nursing <br />{" "}
              Preparedness and prevention of communicable & infectious diseases{" "}
              <br /> Fire Relief operations <br />
